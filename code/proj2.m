...
% [x1, y1, scale1] = get_interest_points_scale(image1_bw, feature_width);
% [x2, y2, scale2] = get_interest_points_scale(image2_bw, feature_width);
...
% [image1_features] = get_features_scale(image1_bw, x1, y1, feature_width, scale1);
% [image2_features] = get_features_scale(image2_bw, x2, y2, feature_width, scale2);
